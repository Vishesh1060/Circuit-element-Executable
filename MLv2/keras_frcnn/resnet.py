...
from tensorflow.keras.layers import Input, Add, Dense, Activation, Flatten, MaxPooling2D, ZeroPadding2D, AveragePooling2D, TimeDistributed
...
def classifier(base_layers, input_rois, num_rois, nb_classes = 21, trainable=False):
    ...
    if K.keras.backend.backend() == 'tensorflow':
        pooling_regions = 14
        input_shape = (num_rois,14,14,1024)
    elif K.keras.backend.backend() == 'theano':
        pooling_regions = 7
